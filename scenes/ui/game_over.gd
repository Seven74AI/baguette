extends Control
## PHASE 4.1: Game Over screen — displayed when player dies.
## Shows death message, run stats, restart/menu buttons.
...
@onready var _restart_button: Button = $CenterContainer/ContentVBox/ButtonsContainer/RestartButton
...
func _apply_bakery_theme() -> void:
	...
	_restart_button.add_theme_stylebox_override("normal", btn_style)
	_menu_button.add_theme_stylebox_override("normal", btn_style)
	_restart_button.add_theme_color_override("font_color", Color(1.0, 0.97, 0.88, 1.0))
